...
import com.example.demo.config.DeveloperProperty;
...
public class TestController {
    ...
    private final TestStrategyFactory factory;
    ...
    public ApiResult<Object> testStrategy(@RequestParam("id") int id) throws Exception {
        ...
        String message = developerProperty.getName() + "-" + developerProperty.getPhoneNumber();
        return ApiResult.SUCCESS("message" + message + "-s:" + s);
    }
